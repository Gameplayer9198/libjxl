...
def main():
    ...
    # Get all JPG and JPEG files in current directory
    current_dir = Path('.')
    files = list(current_dir.glob("*.jpg")) + list(current_dir.glob("*.jpeg"))
    
    # Open log file for writing
    with open('~Jpeg-log.txt', 'w', encoding='utf-8') as log_file:
